...
barplot(sort(imp_classif, decreasing = TRUE)/sum(imp_classif), las = 2, col = cols_class[order(imp_classif, decreasing = TRUE)], ylab = "importance")
text(-5, 0.10, labels = "A", xpd = NA, font = 2, cex = 1.3)
legend("topright", bty = "n", legend = c("Environment","Phylogeny", "Seed"), col = cols , pch = 15)

barplot(sort(imp_regr, decreasing = TRUE)/sum(imp_regr), las = 2, col = cols_reg[order(imp_classif, decreasing = TRUE)], ylab = "importance")
text(-5, 0.10, labels = "B", xpd = NA, font = 2, cex = 1.3)
...
plot_axis = function(w, mgp = c(3, 2, 0)) {
  ...
  axis(1, 
       labels = (format(round(seq(min(pred), max(pred), length.out = 3), 1), 
                        digits = 2, nsmall = 1)),
...
counter = 1
mains = c("Landolt' T", "Seed shape", "Seed weight", "Landolt' F", "Grazing", "Landolt' N", "Productivity")
for(n in c("T", "Shape", "Weight", "F", "Grazing", "N", "Productivity")) {
  ...
  if(n == "T") {
    ...
    text(srt = 90, x = -0.37, y = 0.25, pos = 3, labels = "PA of SSB", xpd= NA)
  }
  text(x=0.01, pos = 3, y = 0.366, labels = LETTERS[counter], font = 2)
  text(x = 0.5, pos = 3, y = 0.41, xpd = NA, labels = mains[counter])
  counter = counter + 1
}
...
for(n in c("T", "Shape", "Weight", "F", "Grazing", "N", "Productivity")) {
  ...
  if(n == "T") {
    ...
    text(srt = 90, x = -0.37, y = 60, pos = 3, labels = "SSB Density", xpd= NA)
  }
